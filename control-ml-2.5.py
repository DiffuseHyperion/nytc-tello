...
class FrontEnd(object):
    ...
    def __init__(self):
        ...
        # Toggle enabling object detection on live feed
        # Warning: will cause lots of lag!
    ...
    def _post_process_image(self, image: np.ndarray, stats: bool, flipped: bool, colour: bool, toggle: bool):
        if stats:
            # Display battery
    ...
    def run(self):
        while not self.should_stop:
            ...
            if self.ai_enabled:
                frame = self._post_process_image(
                    self._process_image(self.frame_read.get_frame()), True, True, False, True)
            else:
                frame = self._post_process_image(self.frame_read.get_frame(), True, True, False, False)
    ...
    def keydown(self, key):
        ...
        if key == pygame.K_UP:  # set forward velocity
            ...
            print("AI on live feed: {}".format(self.ai_enabled))
